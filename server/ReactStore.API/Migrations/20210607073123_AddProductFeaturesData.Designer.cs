...
namespace ReactStore.API.Migrations
{
    ...
    [Migration("20210607073123_AddProductFeaturesData")]
    partial class AddProductFeaturesData
    {
            ...
            modelBuilder.Entity("ReactStore.Domain.Entities.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("38ff18b9-d39b-46c6-b062-129fe630d63c"),
                            Name = "Apple"
                        },
                        new
                        {
                            Id = new Guid("f216d8a5-fa97-4cae-868d-f1832ac54cab"),
                            Name = "Samsung"
                        },
                        new
                        {
                            Id = new Guid("74a8670e-3ebc-480a-98d1-be376aacc123"),
                            Name = "Google"
                        },
                        new
                        {
                            Id = new Guid("679e4301-5305-4a67-b4fd-1e00c8584da3"),
                            Name = "Motorola"
                        },
                        new
                        {
                            Id = new Guid("63550ac0-819b-4fe1-b0ff-d67c9e9e2550"),
                            Name = "LG"
                        });
                });
            ...
            modelBuilder.Entity("ReactStore.Domain.Entities.Color", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ce87ab22-fee4-484b-9cfe-eec956818d9b"),
                            Name = "Black"
                        },
                        new
                        {
                            Id = new Guid("48ca9ac4-769c-460c-b159-728963e4c624"),
                            Name = "White"
                        },
                        new
                        {
                            Id = new Guid("3a2c62e1-33e4-4fe5-b205-455cfd4909a1"),
                            Name = "Blue"
                        },
                        new
                        {
                            Id = new Guid("d2858ae6-ea7e-47ce-ba35-d0f081400c7d"),
                            Name = "Green"
                        },
                        new
                        {
                            Id = new Guid("2697ef18-d8d2-40f1-b233-1fb592180fa0"),
                            Name = "Purple"
                        },
                        new
                        {
                            Id = new Guid("18704e75-1d36-44e8-9dc9-00600cb7839d"),
                            Name = "Red"
                        },
                        new
                        {
                            Id = new Guid("9ed41180-edba-42b9-8437-008c9d5403b6"),
                            Name = "Red"
                        },
                        new
                        {
                            Id = new Guid("7f88de38-e6af-471a-a32f-4b235bfa1f30"),
                            Name = "Pink"
                        },
                        new
                        {
                            Id = new Guid("603d1187-53e9-450e-a96a-ef507a801582"),
                            Name = "Grey"
                        });
                });
            ...
            modelBuilder.Entity("ReactStore.Domain.Entities.Feature", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb982040-d01a-4b26-953a-fd05db70f708"),
                            Name = "5G"
                        },
                        new
                        {
                            Id = new Guid("ebd086b4-9e7c-4327-a4bf-ef1b264e6504"),
                            Name = "4G"
                        },
                        new
                        {
                            Id = new Guid("639ce794-20ab-49ed-b141-86916d2130c4"),
                            Name = "Memory Expandable"
                        },
                        new
                        {
                            Id = new Guid("3e71a9e4-adbb-4eb6-b590-366442331e02"),
                            Name = "USB-C Connector"
                        },
                        new
                        {
                            Id = new Guid("a4a33046-34e2-412e-8c38-b1f91c32aed5"),
                            Name = "Fast Charger"
                        },
                        new
                        {
                            Id = new Guid("361e9a03-8d9b-4359-9c63-9ac29dbb1476"),
            ...
            modelBuilder.Entity("ReactStore.Domain.Entities.OS", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("18a9bad9-25f7-4322-81eb-d78b9c38c3ef"),
                            Name = "Android"
                        },
                        new
                        {
                            Id = new Guid("2f22c68f-a724-4b7c-a0c4-c1f3349ed70a"),
                            Name = "iOS"
                        });
                });
            ...
            modelBuilder.Entity("ReactStore.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("79c8c147-b440-4167-85fb-d6195da68d16"),
                        ...
                        new
                        {
                            Id = new Guid("08811135-21ea-4321-bf7e-85707d182052"),
                            BrandId = new Guid("6213ab61-e37d-40fe-9fd9-61ea21fba50b"),
                            Description = "The best iPhone display ever for incredible contrast and higher resolution. With Ceramic Shield, which has four times better drop performance. Superfast speeds. Superlow latency. So you can get faster downloads, better-quality video streaming, more responsive gaming and real-time interactivity.A14 Bionic is the fastest chip in a smartphone. With a 16-core Neural Engine, it crunches trillions of operations each second. And it’s superefficient for great battery life.",
                            Name = "iPhone 12",
                            OSId = new Guid("bc052339-a7a9-429f-a673-b03589b84fad"),
                        ...
                        new
                        {
                            Id = new Guid("bd688fec-4dfb-45d5-8527-679474cc6aed"),
                            BrandId = new Guid("6213ab61-e37d-40fe-9fd9-61ea21fba50b"),
                        ...
                        new
                        {
                            Id = new Guid("d6c02ad5-dd53-4364-bf15-79b36d0ef767"),
                        ...
                        new
                        {
                            Id = new Guid("cdbb1268-cfc1-4862-9c17-3a5907e97f9a"),
                        ...
                        new
                        {
                            Id = new Guid("3b33f02b-f7f2-4a43-9957-136aca12b769"),
                            BrandId = new Guid("7360baa4-71c3-442d-9328-7f9cfbdf5e1f"),
                        ...
                        new
                        {
                            Id = new Guid("6b48cfe7-b6dd-49a8-9f80-d8e2b05ab376"),
                            BrandId = new Guid("7360baa4-71c3-442d-9328-7f9cfbdf5e1f"),
                            Description = "Create share-ready GIFs and videos in one take1 or pick your favourite moments and pull your favorite stills in super high res to share with your followers. Zoom in close, take photos and videos like a pro, and capture incredible share-ready moments with our easy-to-use, multi-lens camera. Power every scroll, click, tap, and stream all day long and then some with an intelligent battery that works with you, not against you. A night out. Your best friend's birthday party. Family moments you'll want to remember forever. Capture your life's best moments in head-turning, super smooth 8K video.",
            ...
            modelBuilder.Entity("ReactStore.Domain.Entities.Storage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("99931e66-98fa-4ecf-b02f-2f5347e32d31"),
                            Capacity = "32GB"
                        },
                        new
                        {
                            Id = new Guid("4b0ee8d9-ed4c-4298-9a43-d17c4ed2ee6a"),
                            Capacity = "64GB"
                        },
                        new
                        {
                            Id = new Guid("ac5bf05b-f85e-4a59-a7cf-2bca43241b7b"),
                            Capacity = "128GB"
                        },
                        new
                        {
                            Id = new Guid("a9f9b6b7-7d7a-4e63-8971-84b557032ab3"),
                            Capacity = "256GB"
                        },
                        new
                        {
                            Id = new Guid("fb4f0cd5-b1c8-4082-b583-9ab95b6949c8"),
                            Capacity = "512GB"
                        });
                });
